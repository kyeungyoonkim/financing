...
export const DEFAULT_CARD_BENEFITS: CardBenefit[] = [
  ...
  },
  {
    ...
    description: '매년 1/1 기준 15 elite night credits 자동 적립 → Silver 등급 자동 달성',
    frequency: 'annual',
    requirement: '숙박권 아님 · Bonvoy 등급(실버/골드 등) 달성용 박 수',
  },
  {
    ...
    description: '$5,000 사용마다 elite night credit 1박 추가 (상한 없음) · 숙박권/포인트 교환 아님',
    frequency: 'ongoing',
    requirement: 'Bonvoy 등급용 · 골드 25박·플래티넘 50박 등에 합산 · 연 $35K 사용 시 골드 자동',
  },
  {
    id: 'marriott-silver',
    cardId: 'marriott-boundless',
