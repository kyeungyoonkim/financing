...
export const DEFAULT_CARDS: CreditCard[] = [
  ...
  },
  {
    ...
    issueDate: '25/07',
    creditLimit: 9500,
    notes: 'Marriott 6x. 6개월마다 항공 $250+ → $50 캐시백. 그 외 2x.',
  ...
  },
  {
    ...
    issueDate: '25/04',
    creditLimit: 9900,
    notes: '식당·스트리밍 3x. 여행·항공·호텔 2x. UR 전환 가능.',
    earningRates: [
  ...
  },
  {
    ...
    issueDate: '22/03',
    creditLimit: 3000,
    notes: '기본 1.5x. 식당·약국 3x. Chase Travel 포털만 5x.',
    earningRates: [
      { category: 'dining', rate: 3 },
